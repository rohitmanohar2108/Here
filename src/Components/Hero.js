            ...
            <div className="relative mobile-glass rounded-lg p-6 sm:p-8">
              ...
              <div className="flex  justify-center gap-4">
                <button
                  ...
                  className="px-6 py-2 rounded-full text-sm bg-purple-500/20 text-pink-300 border border-purple-500/30 hover:bg-purple-500/30 transition-colors touch-highlight"
                >
                  View Projects
                </button>
                <button
